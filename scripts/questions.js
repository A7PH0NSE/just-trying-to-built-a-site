const questions = [
    ...
    },
    {
        ...
        options: ["I'll Lose on purpose", "Easy win", "Close win", "Tactical warfare", "Complete loss"],
        key: "physique"
    },
    {
        /*question: "What is the first color you want to see when you wake up in the morning?",
        options: ["Warm colors", "Cold colors", "Bright", "I don't care"],
        key: "hair color",
        subOptions: {
    ...
    },
    {
        ...
        options: ["A Gentle gaze", "Mocking", "Emotionless", "Concerned"],
        key: "personality"
